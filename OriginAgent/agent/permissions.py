...
def infer_device_domain(scope: str, action: str) -> str:
    try:
        from OriginAgent.domain_packs.smart_home.runtime.permissions import infer_device_domain as impl
    except Exception:
        return "general"
...
def _normalize_household_role(role: str | None) -> str:
    try:
        from OriginAgent.domain_packs.smart_home.runtime.permissions import _normalize_role as impl
    except Exception:

            ...
            {loading ? (
              ...
              <div className="rounded-lg border border-dashed border-border/70 bg-background/45 p-4 text-sm text-muted-foreground">
                ...
                <p className="mt-1 text-xs text-muted-foreground/70">
                  {t("reviews.emptyHint", "Review proposals are generated by Background Review and Curator after successful turns. Enable them in Learning settings to start receiving proposals.")}
                </p>
              </div>
            ) : (

"""High-level programmatic interface to OpenHome."""
...
from OpenHome.agent.hook import AgentHook, SDKCaptureHook
...
class OpenHome:
    """Programmatic facade for running the OpenHome agent.

    Usage::

        bot = OpenHome.from_config()
    ...
    def from_config(
        ...
        *,
        ...
        """Create a OpenHome instance from a config file.

        Args:
            config_path: Path to ``config.json``.  Defaults to
                ``~/.openhome/config.json``.

...
Persistent storage at ``~/.OpenHome/pairing.json`` keeps approved senders
...
from OpenHome.config.paths import get_data_dir
from OpenHome.utils.helpers import _write_text_atomic

...
description: Cooperate with OpenHome's system safety layer for physical device actions.
---

# Safety Confirmation

This skill informs the model about safety boundaries for smart home actions. It
does not replace OpenHome's system safety layer. Final confirmation,

...
from OpenHome.domain_packs.smart_home.runtime.device_actions import TypedDeviceAction
from OpenHome.domain_packs.smart_home.runtime.device_backends import DeviceActionExecutor
from OpenHome.domain_packs.smart_home.runtime.devices import DeviceRegistry
from OpenHome.domain_packs.smart_home.tools.device_messages import device_human_message
...
class _LightingToolBase(Tool):
    ...
    def description(self) -> str:
        return "Submit a typed low-risk lighting action through the OpenHome device gateway."
...
class LightingSetPowerTool(_LightingToolBase):
    canonical_action_id = "openhome.device.lighting.set_power"
...
class LightingSetBrightnessTool(_LightingToolBase):
    canonical_action_id = "openhome.device.lighting.set_brightness"
    action_type = "set_light_brightness"
    name = "openhome_device_lighting_set_brightness"
...
class LightingSetColorTemperatureTool(_LightingToolBase):
    canonical_action_id = "openhome.device.lighting.set_color_temperature"
    action_type = "set_light_color_temperature"
    name = "openhome_device_lighting_set_color_temperature"

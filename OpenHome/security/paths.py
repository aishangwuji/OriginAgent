...
from OpenHome.config.paths import get_cron_dir, get_data_dir, get_media_dir
...
class ProtectedPathPolicy:
    """Central read/list/write policy for OpenHome runtime state paths."""
    ...
    def __init__(self, workspace: Path | None = None):
        ...
        try:
            ...
            data_dir = _resolve_loose(Path.cwd() / ".openhome")
        try:

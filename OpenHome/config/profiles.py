"""Runtime profile presets for common OpenHome operating modes."""

from __future__ import annotations

from OpenHome.config.schema import Config, DeviceToolsConfig, ExecToolConfig, RuntimeProfile, ToolAuditConfig

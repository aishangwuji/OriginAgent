...
This directory contains built-in skills that extend OpenHome's capabilities.
...
When skills reference large local documentation or logs, prefer OpenHome's built-in

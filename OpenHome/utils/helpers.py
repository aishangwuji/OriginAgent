"""Utility functions for OpenHome."""
...
_TOOL_RESULTS_DIR = ".openhome/tool-results"
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        tpl = pkg_files("OpenHome") / "templates"
    except Exception:
        return []
    if not tpl.is_dir():
        return []
    ...
    try:
        from OpenHome.utils.gitstore import GitStore

"""MCP client: connects to MCP servers and wraps their tools as native OpenHome tools."""
...
from OpenHome.agent.tools.registry import DuplicateToolError, ToolRegistry
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a OpenHome Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only OpenHome Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only OpenHome Tool."""

...
from OpenHome.config.schema import ImageGenerationToolConfig
from OpenHome.providers.image_generation import (
...
from OpenHome.utils.helpers import detect_image_mime
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        if not any(_is_relative_to(resolved, root) for root in allowed_roots):
            raise ImageGenerationError(
                "reference_images must be inside the workspace or OpenHome media directory"
            )

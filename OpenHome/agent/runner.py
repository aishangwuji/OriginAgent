...
from OpenHome.agent.tools.ask import AskUserInterrupt
...
from OpenHome.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set OPENHOME_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("OPENHOME_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)

...
from OpenHome.agent.tools.ask import AskUserTool
...
def register_default_tools(
    ...
    *,
    ...
    registry.register(LongTaskTool(sessions=sessions, bus=bus))
    registry.register(CompleteGoalTool(sessions=sessions, bus=bus))
    registry.register(
        ReadFileTool(
            workspace=workspace,
    ...
    registry.register(MessageTool(send_callback=bus.publish_outbound, workspace=workspace))

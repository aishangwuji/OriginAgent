...
This project is indexed by GitNexus as **OriginAgent** (28122 symbols, 57500 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

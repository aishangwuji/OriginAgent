...
This project is indexed by GitNexus as **OriginAgent** (25245 symbols, 52383 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

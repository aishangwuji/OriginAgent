...
This project is indexed by GitNexus as **OriginAgent** (29331 symbols, 58647 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

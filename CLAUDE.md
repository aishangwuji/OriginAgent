...
This project is indexed by GitNexus as **OriginAgent** (28549 symbols, 57379 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

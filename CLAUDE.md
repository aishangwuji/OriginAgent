...
This project is indexed by GitNexus as **OriginAgent** (25902 symbols, 53542 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **OriginAgent** (22811 symbols, 48150 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

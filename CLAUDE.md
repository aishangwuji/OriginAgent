...
This project is indexed by GitNexus as **OriginAgent** (26296 symbols, 55538 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

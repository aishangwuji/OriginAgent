...
def test_control_plane_executes_write_when_manual_override_enabled(tmp_path: Path) -> None:
    ...
    suppressed = plane.execute_action("suppress_signal", target_id=signal_id, reason="not useful")
    resumed = plane.execute_action("resume_signal", target_id=signal_id, reason="reconsider")

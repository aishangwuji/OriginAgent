...
def test_build_body_strips_meta_without_mutating_messages():
    """Responses API body construction must remove internal metadata on a copy."""
    provider = AzureOpenAIProvider(api_key="k", api_base="https://r.com", default_model="gpt-4o")
    messages = [{
        "role": "user",
        "content": [

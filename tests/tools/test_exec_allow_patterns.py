"""Tests for allow_patterns and hard deny precedence."""
...
def test_allow_patterns_cannot_bypass_builtin_hard_deny():
    """allow_patterns cannot override hard deny patterns."""
...
def test_allow_patterns_cannot_bypass_extra_deny():
    """allow_patterns cannot override user-supplied hard deny patterns."""
    tool = ExecTool(

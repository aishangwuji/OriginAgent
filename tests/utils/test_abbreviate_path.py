...
import os
from OriginAgent.utils.path import abbreviate_path
...
class TestAbbreviatePathWindows:
    def test_windows_drive_path(self):
        path = "D:\\Documents\\GitHub\\OriginAgent\\src\\utils\\helpers.py"
    ...
    def test_windows_home(self):
        home = os.path.expanduser("~")
        path = os.path.join(home, ".OriginAgent", "workspace", "log.txt")
